...
function update() {
  ...
  *      FOR HTML CONTROLS        *
  ********************************/
	(0, _jquery2.default)('.left').mousedown(function () {
		player.body.velocity.x = -550;
	});
	(0, _jquery2.default)('.right').mousedown(function () {
		player.body.velocity.x = 550;
	});
	(0, _jquery2.default)('.up').mousedown(function () {
	...
	if (isAlive) {
		(0, _jquery2.default)('.fireBtn').on('click', function (event) {
			event.preventDefault();
			playerFires();
		});
	} else {
		(0, _jquery2.default)('.fireBtn').off('click');
	}
}
...
function playerCollide(player, enemy) {
	...
	isAlive = false;
	game.paused = true;
	(0, _jquery2.default)('.gameOver').fadeIn('fast');
	(0, _jquery2.default)('.dynamicScore').text(score);
	(0, _jquery2.default)('.score').fadeIn('fast');
}
...
(0, _jquery2.default)('.startBtn').on('click', function (event) {
	event.preventDefault();
	(0, _jquery2.default)(this).fadeOut('fast', function () {
		game.paused = false;
		gameStarted = true;
	});
});
